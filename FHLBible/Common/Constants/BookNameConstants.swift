//
//  BookNameConstants.swift
//  FHLBible
//
//  Created by snowray712000@gmail.com on 2021/6/10.
//

import Foundation


open class BookNameConstants {
    ...
    /** @const {string[]} '創', '出', '利'... */
    static let CHINESE_BOOK_ABBREVIATIONS = [
        "創", "出", "利", "民", "申",
    ...
    /** @const {string[]} '创', '出', '利',... */
    static let CHINESE_BOOK_ABBREVIATIONS_GB = [
        "创", "出", "利", "民", "申",
    ...
    static let CHINESE_BOOK_NAMES_GB = [
    ...
    static let ENGLISH_BOOK_ABBREVIATIONS = [
    "Gen", "Ex", "Lev", "Num", "Deut",
    ...
    static let ENGLISH_BOOK_SHORT_ABBREVIATIONS = [
    "Ge", "Ex", "Le", "Nu", "De",
    "Jos", "Jud", "Ru", "1Sa", "2Sa",
